...
def main(jsonl_file):
    ...
    if entries:
        root = tk.Tk()
        root.title("Chewbaca")
        root.geometry("700x450")  # Even larger window size for better layout
        ...
        listbox = tk.Listbox(root, selectmode=tk.SINGLE, width=70, height=15, bg='#F0F0F0', font=("Arial", 12))
        ...
        login_button = tk.Button(button_frame, text="Login", command=on_login, width=12, font=("Arial", 12), bg='#A9A9A9')
        ...
        delete_button = tk.Button(button_frame, text="Delete", command=on_delete, width=12, font=("Arial", 12), bg='#A9A9A9')
        ...
        add_button = tk.Button(button_frame, text="Add", command=on_add, width=12, font=("Arial", 12), bg='#A9A9A9')
        add_button.pack(side=tk.LEFT, padx=5)

        # Access Database button
        def on_access_database():
            selection = listbox.curselection()
            if selection:
                selected_entry = entries[selection[0]]
        ...
        access_button = tk.Button(button_frame, text="SQL Access", command=on_access_database, width=12, font=("Arial", 12), bg='#A9A9A9')
        ...
        exit_button = tk.Button(button_frame, text="Exit", command=on_exit, width=12, font=("Arial", 12), bg='#A9A9A9')
